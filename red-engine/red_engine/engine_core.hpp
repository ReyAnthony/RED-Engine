...
namespace RedEngine
{
	...
	/*
		This class show a console to interact with some of the game parameters.
		We can bind new commands from outside of the library to interact with the game and do debug.
		It will also print debugs output. 
		Ideally, only activate it when the lib is compiled with DEBUG flag.
	*/
	class Console {
